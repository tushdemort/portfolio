  ...
  render() {
    return (
      <>
        ...
        <div class="wrapper">
          <div className='cell1'><Cards name='WILP' desc='Developed a tool for WILP professors to generate, modify and store question. Further these questions are used to generate question papers for students during their Midterms and Endsems.' link='https://wilp-professor-end.onrender.com'/></div>
